        ...
        .row.g-0
          ...
          .col-xl-6.info-section
            .content-wrapper.px-lg-4.pt-lg-4.px-xxl-5.py-xxl-5.text-start
              ...
              p.descripcion.mb-4 Desde la educación infantil, el diseño de propuestas didácticas requiere un análisis crítico para garantizar su pertinencia y funcionalidad en distintos contextos educativos. En esta unidad, se explorará la importancia de evaluar la coherencia entre los principios pedagógicos institucionales y la planificación didáctica, considerando tanto las políticas nacionales como las necesidades del entorno escolar.
              p #[b ¡Prepárese para fortalecer su práctica pedagógica con análisis crítico y toma de decisiones fundamentada!]
